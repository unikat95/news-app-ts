...
export default function Footer() {
  ...
  return (
    <div className="w-full h-auto flex flex-col justify-center items-center bg-slate-900 text-white text-sm relative bottom-0 ">
      <div className="w-full max-w-[1300px] h-full flex justify-start items-start bg-slate-900 py-14 px-5 xl:px-0 gap-10">
      ...
      <div className="w-full h-full flex justify-center items-center bg-slate-950 py-5">
